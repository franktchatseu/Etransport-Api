...
class gearpictureController extends Controller
{
    ...
    public function update(Request $req, $id)
    {
        ...
        if ($data['fore_gear'])$gearpicture->fore_gear = $data['fore_gear'];
        if ($data['rear_gear'])$gearpicture->rear_gear = $data['rear_gear'];
        if ($data['left_side_gear'])$gearpicture->left_side_gear = $data['left_side_gear'];
        if ($data['right_side_gear'])$gearpicture->right_side_gear = $data['right_side_gear'];
        if ($data['insurance_patente'])$gearpicture->insurance_patente = $data['insurance_patente'];
        if ($data['grey_card'])$gearpicture->grey_card = $data['grey_card'];
        if ($data['stepper_id'])$gearpicture->stepper_id = $data['stepper_id'];
